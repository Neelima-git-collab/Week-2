...
Explored brand vs price, range distribution, and correlations

Built two ML models:

Model 1: Predict EV Price (Price_in_USD)

Model 2: Predict EV Range (Range_km)
...
range_model.pkl – trained range prediction model
